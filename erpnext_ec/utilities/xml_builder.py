...
class XMLGenerator:
    ...
    def generate_xml(self, root_tag, data_dict, version="1.1.0"):
...
def build_xml_data(data_object, doc_name, typeDocSri, siteName):
    ...
    # Generar el XML
    xml_doc = xml_generator.generate_xml(element_name, data, doc_version)

    xml_doc = fix_infoAdicional(xml_doc)

    # Eliminar elementos vacíos antes de validar contra el XSD
